<%-- 
    Document   : cancelCertainDay
    Created on : Jan 15, 2021, 11:29:33 AM
    Author     : George
--%>
...
<html>
    ...
    <body>
        ...
        <form action="cancelDay">
            <p>Enter The Appointment Day</p>
            <input type="text" name="appointmentDay">
            <input type="submit" value="Cancel Specific Day">
        </form>
    </body>
</html>
